...
public class GenreController {
    ...
    @GetMapping("/newgenre")
    public String pagenewgenre(Model model)
    {
        ...
        return "insertion_genre";
    }

    @PostMapping("/insertnewgenre")
    public String insertnewgenre(@RequestParam(name="description", required=true) String description, Model model)
    {
        Genre newgenre = new Genre(description);
        try {
